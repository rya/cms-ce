 ...
 */
package com.enonic.cms.domain.content.index.translator.expression;

import java.util.HashMap;

import org.junit.Test;

import com.enonic.cms.domain.content.index.optimizer.LogicalOrOptimizer;
import com.enonic.cms.domain.content.index.queryexpression.Expression;
import com.enonic.cms.domain.content.index.queryexpression.QueryExpr;
import com.enonic.cms.domain.content.index.queryexpression.QueryParser;
...
public class ExpressionTranslatorTest
{
    ...
    public void combinedLogicalOrExprTranslatorWithDifferentFields()
    {
        ...
        assertEquals(
            "( x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND orderValue = :v0) OR x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'b' AND orderValue = :v1) OR x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'c' AND orderValue = :v2) )",
            translatedExpr );
    ...
    public void combinedLogicalOrExprTranslatorWithSingleRightValue()
    {
        ...
        assertEquals(
            "x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND orderValue = :v0)",
            translatedExpr );
    }
    ...
    public void combinedLogicalOrExprTranslatorWithSameFieldsAndNumberValues()
    {
        ...
        assertEquals(
            "( x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND (orderValue = :v0 OR orderValue = :v1 OR orderValue = :v2)) )",
            translatedExpr );
    }
    ...
    public void combinedLogicalOrExprTranslatorWithSameFieldsAndANDClause()
    {
        ...
        assertEquals(
            "x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND orderValue = :v0) AND ( x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND (orderValue = :v1 OR value = :v2)) )",
            translatedExpr );
    ...
    public void combinedLogicalOrExprTranslatorWithSameFieldsAndInvertedANDClause()
    {
        ...
        assertEquals(
            "( x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND (orderValue = :v0 OR orderValue = :v1)) ) AND x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND orderValue = :v2)",
            translatedExpr );
    ...
    public void combinedLogicalOrExprTranslatorWithSameFieldsAndStringValues()
    {
        ...
        assertEquals(
            "( x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND (value = :v0 OR value = :v1 OR value = :v2)) )",
            translatedExpr );
    ...
    public void combinedLogicalOrExprTranslatorWithSameFieldsAndStringAndNumberValues()
    {
        ...
        assertEquals(
            "( x.contentKey IN ( SELECT contentKey FROM com.enonic.cms.domain.content.ContentIndexEntity WHERE path LIKE 'a' AND (orderValue = :v0 OR value = :v1 OR value = :v2)) )",
            translatedExpr );

...
import com.enonic.cms.portal.image.filter.AwtImageFilter;
import com.enonic.cms.portal.image.filter.AwtImageFilterTest;
        ...
        extends AwtImageFilterTest
{
    ...
    public void testOpaqueImage()
    {
        ...
        com.enonic.cms.portal.image.filter.ImageFilter filter = new AwtImageFilter( operation );

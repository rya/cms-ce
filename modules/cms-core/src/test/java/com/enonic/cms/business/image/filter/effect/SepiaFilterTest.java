...
import com.enonic.cms.business.image.filter.AwtImageFilter;
import com.enonic.cms.business.image.filter.AwtImageFilterTest;
        ...
        extends AwtImageFilterTest
{
    ...
    public void testOpaqueImage()
    {
        ...
        com.enonic.cms.business.image.filter.ImageFilter filter = new AwtImageFilter( operation );

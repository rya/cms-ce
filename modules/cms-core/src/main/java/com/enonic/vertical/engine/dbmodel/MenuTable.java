    ...
    extends Table
{
    ...
    public Column men_dteTimestamp =
        new Column( "men_dteTimestamp", "timestamp", true, false, Constants.COLUMN_CURRENT_TIMESTAMP, null, -1 );

    public Column men_mei_firstPage = new Column( "men_mei_firstPage", "firstpage", false, false, Constants.COLUMN_INTEGER, null, -1 );

    public Column men_mei_loginPage = new Column( "men_mei_loginPage", "loginpage", false, false, Constants.COLUMN_INTEGER, null, -1 );

    public Column men_mei_errorPage = new Column( "men_mei_errorPage", "errorpage", false, false, Constants.COLUMN_INTEGER, null, -1 );
    ...
    public Column men_sName = new Column( "men_sName", "name", false, false, Constants.COLUMN_VARCHAR, null, 64 );

    public Column men_xmlData = new Column( "men_xmlData", "xmldata", false, false, Constants.COLUMN_XML, null, 1 );
    ...
    public Column men_sStatisticsURL = new Column( "men_sStatisticsURL", "statistics", false, false, Constants.COLUMN_VARCHAR, null, 256 );

    ...
    extends Table
{
    ...
    public Column grp_hKey = new Column( "grp_hKey", "@key", true, true, Constants.COLUMN_CHAR, null, 40 );

    public Column grp_sName = new Column( "grp_sName", "name", true, false, Constants.COLUMN_VARCHAR, null, 256 );
    ...
    public Column grp_sDescription = new Column( "grp_sDescription", "description", false, false, Constants.COLUMN_VARCHAR, null, 1024 );

    public Column grp_bIsDeleted = new Column( "grp_bIsDeleted", "@deleted", true, false, Constants.COLUMN_BOOLEAN, Boolean.FALSE, -1 );

    public Column grp_bRestricted = new Column( "grp_bRestricted", "@restricted", true, false, Constants.COLUMN_BOOLEAN, Boolean.TRUE, -1 );

    public Column grp_sSyncValue = new Column( "grp_sSyncValue", "@syncvalue", true, false, Constants.COLUMN_VARCHAR, null, 2048 );

    public Column grp_lType = new Column( "grp_lType", "@type", true, false, Constants.COLUMN_INTEGER, null, -1 );

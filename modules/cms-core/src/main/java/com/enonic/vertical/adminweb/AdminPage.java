        ...
        if ( user == null )
        {
            ...
            if ( remoteUserUID != null )
            {
                try
                {
                    ...
                    if ( remoteUser != null )
                    {
                        if ( adminConsoleLoginAccessResolver.hasAccess( securityService.getUser( remoteUser ) ) )
                        {
                            ...
                            VerticalAdminLogger.info( this.getClass(), 0, message, remoteUserUID, null );
                        }
                        else
                        {
                            String message = "User %0 is not authorized to use administration console.";
                            VerticalAdminLogger.error( this.getClass(), 0, message, remoteUserUID, null );
                        }
                    }
                    else
                    {
                ...
                catch ( VerticalSecurityException vse )
                {
                    ...
                    VerticalAdminLogger.error( this.getClass(), 0, message, remoteUserUID, vse );
                }
            }
        }
        ...
        else
        {
            ...
            if ( enctype != null && enctype.startsWith( "multipart/form-data" ) )
            {
                ...
                catch ( IllegalArgumentException iae )
                {
                    ...
                    VerticalAdminLogger.fatalAdmin( this.getClass(), 0, message, iae );
                }
            }
            else
            {
            ...
            catch ( NumberFormatException nfe )
            {
                ...
                VerticalAdminLogger.error( this.getClass(), 0, message, pageStr, nfe );
            ...
            switch ( page )
            {
                ...
                case 900:
                    ...
                    break;
                case 910:
                    servlet = "/admin/servlet/tools/com.enonic.cms.server.service.tools.PluginInfoController";
                    break;
                case 912:
                    servlet = "/admin/servlet/tools/com.enonic.cms.server.service.tools.LivePortalTraceController";
                    break;
                case 914:
                    servlet = "/admin/servlet/tools/com.enonic.cms.server.service.tools.ConnectionInfoController";
                    break;
                  case 916:
                    servlet = "/admin/servlet/tools/com.enonic.cms.server.service.tools.ReindexContentToolController";
                    break;
                case 950:
            ...
            catch ( Exception e )
            {
                ...
                VerticalAdminLogger.error( this.getClass(), 3, message, servlet, e );

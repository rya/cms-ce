...
/*
 * ZipEntry.java -- Copyright (C) 2001, 2002, 2004, 2005 Free Software Foundation, Inc. This file is part of GNU
    ...
    implements ZipConstants, Cloneable
{
    ...
    public void setTime( long time )
    {
        ...
        synchronized ( cal )
        {
            ...
            dostime = ( cal.get( Calendar.YEAR ) - 1980 & 0x7f ) << 25 | ( cal.get( Calendar.MONTH ) + 1 ) << 21 |
                ( cal.get( Calendar.DAY_OF_MONTH ) ) << 16 | ( cal.get( Calendar.HOUR_OF_DAY ) ) << 11 |

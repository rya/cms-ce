...
var $ice = jQuery.noConflict(true);
/*!
jquery.event.drag.js ~ v1.5 ~ Copyright (c) 2008, Three Dub Media (http://threedubmedia.com)
Liscensed under the MIT License ~ http://threedubmedia.googlecode.com/files/MIT-LICENSE.txt
*/
;(function($ice){ // secure $ jQuery alias
/*******************************************************************************************/
...
// jquery method
$ice.fn.drag = function( fn1, fn2, fn3 ){
...
// local refs
var $event = $ice.event, $special = $event.special,
	...
	switch ( event.type ){
		...
		case !drag.dragging && 'mousemove':
			...
			if ( returned !== false ){ // "dragstart" not rejected
				...
				drag.proxy = event.dragProxy = $ice( returned || elem )[0]; // set proxy
				}
		// mousemove, dragging
		case 'mousemove':
			if ( drag.dragging ){
...
function hijack ( event, type, elem ){
	...
	var result = $ice.event.handle.call( elem, event );

Ext.define( "CMS.view.dashboard.DashboardCanvas", {
    ...
    requires: [
        ...
        "CMS.view.dashboard.DropTarget",
        "CMS.view.dashboard.DashletColumn"
    ],
    cls: "dashboard",
    ...
    initEvents: function () {
        this.callParent();
        this.dd = Ext.create("CMS.view.dashboard.DropTarget", this, this.dropConfig)
    },

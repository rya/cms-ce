...
tinyMCEPopup = {
	...
	pickColor : function(e, element_id) {
      ...
      // color : window.frames['mainFrame'].document.getElementById(element_id).value,
			func : function(c) {
        var el = document.getElementById(element_id) || window.frames['mainFrame'].document.getElementById(element_id);
				el.value = c;

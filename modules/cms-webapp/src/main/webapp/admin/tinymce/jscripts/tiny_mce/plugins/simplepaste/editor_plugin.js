...
(function() {
	...
	tinymce.create('tinymce.plugins.SimplePastePlugin', {
		init : function(ed, url) {
			...
			// Listen to ctrl-v, and clean content afterwards. This does not work for Opera en Safari
			// But Safari has the onPaste event and Opera cleans everything itself.

...
// ---------------------------------------------------------------------------------------------------------------------
/*
  Method: cmsAddEnterEvent

  Adds a keyboard event to all text input fields and listens for enter (Ok/Confirm) or escape (close window)

  Parameters:

    form - Parent form element for the input text fields.
*/

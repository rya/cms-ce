...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:include href="../common/tablecolumnheader.xsl"/>
    ...
    <xsl:template name="formbuilder_javascript">
		...
		function Dropdown()
		{
			this.addFields = Dropdown_addFields;
		}

        function Dropdown_addFields(ownerDoc, table, tr)
		{
			// empty td element
			//tr.insertCell();
			...
			var _type = ownerDoc.createTextNode('%optFieldDropdown%');
        ...
        function getObject()
		{
			Dropdown.prototype = new FieldPrototype(document.getElementById('fieldtype').value, document.getElementsByName('field_label')[0].value, document.getElementsByName('field_helptext')[0].value);
			var textArea = new Dropdown();
			return textArea;
        }

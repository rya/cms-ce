<html>
    ...
    <body>
        ...
        <div class="infoBox errorMessage">${details.message?html}</div>
        <div class="infoBox">
            <ul id="minitabs">
            ...
            <div id="tab3box" class="detailBox" style="display:none;">
                ...
                <div class="detailPart">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <@printKeyValue key="protocol" value="${details.request.protocol}"/>
                        <@printKeyValue key="scheme" value="${details.request.scheme}"/>
                        <@printKeyValue key="serverName" value="${details.request.serverName}"/>
                        <@printKeyValue key="method" value="${details.request.method}"/>

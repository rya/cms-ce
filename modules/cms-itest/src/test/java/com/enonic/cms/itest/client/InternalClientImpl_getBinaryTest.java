...
public class InternalClientImpl_getBinaryTest
{
    ...
    public void getBinary()
    {
        ...
        ContentKey contentKey =
            createFileContent( "Dummy name", new byte[]{1, 2, 3}, com.enonic.cms.core.content.ContentStatus.APPROVED, "MyCategory" );
    ...
    private ContentKey createFileContent( String name, byte[] bytes, com.enonic.cms.core.content.ContentStatus contentStatus,
                                          String categoryName )
    {

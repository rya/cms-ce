...
public class ContentServiceImpl_contentConfigTest
{
        ...
        throws ParseException
    {
        ...
        ctyconf.endBlock();
        Document configAsDom = XMLDocumentFactory.create(ctyconf.toString());
        fixture.save( factory.createContentType( "Person", ContentHandlerName.CUSTOM.getHandlerClassShortName(), configAsDom ) );
    ...
    public void testCreateContentThrowsMissingRequiredContentDataExceptionWhenValueForTitleInputOfTypeDateIsNull()
    {
        ...
        catch ( Exception e )
        {
            assertTrue( "Expected CreateContentException, was: " + e.getClass().getName(),
                        e instanceof com.enonic.cms.core.content.CreateContentException );
